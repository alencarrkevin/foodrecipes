...
const SignUpScreen = () => {
  ...
  const handleSignUp = async () => {
    ...
    if (password.length < 6) return Alert.alert("Error", "senha muito curta, minimo 6 caracteres");
    ...
    try {
      ...
      Alert.alert("Error", err.errors?.[0]?.message || "erro ao criar a conta");
          ...
          <View style={authStyles.formContainer}>
            ...
            <TouchableOpacity style={authStyles.linkContainer} onPress={() => router.back()}>
              <Text style={authStyles.linkText}>
                Já Possui uma conta? <Text style={authStyles.link}>Login</Text>
              </Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
